...
#SBATCH --mem=18G ## memory to allocate for your job in MB
...
STAR --runMode genomeGenerate --genomeDir Oc_gen1 \
 --genomeFastaFiles /lustre1/home/mass/eskalon/Oculina/genome/GCA_052425735.1_crgOcupat_genomic.fna \
 --sjdbGTFfile /lustre1/home/mass/eskalon/Oculina/genome/genomic.gtf \
 --sjdbOverhang 110 \
