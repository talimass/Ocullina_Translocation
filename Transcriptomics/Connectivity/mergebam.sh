...
REF="./GCA_052425735.1_crgOcupat_genomic.fna"
...
for R1 in ${TAGs[@]}; do
 ...
 gatk --java-options "-Xmx128G -XX:ParallelGCThreads=32" MergeBamAlignment \
                	--REFERENCE_SEQUENCE ${REF} \
                	--UNMAPPED_BAM ${OUT}.FastqToSam.unmapped.rg.bam \
                	--ALIGNED_BAM \
 /lustre1/home/mass/eskalon/hiba/op_align_new/bam/${R1}Aligned.sortedByCoord.out.bam \
